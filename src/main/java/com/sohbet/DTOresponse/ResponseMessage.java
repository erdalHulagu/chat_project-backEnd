...
public class ResponseMessage {
	...
	public final static String PRODUCT_DELETE_RESPONSE_MESSAGE = "Product has been deleted.";

	public final static String CATEGORY_UPDATE_RESPONSE_MESSAGE = "Category has been successfully updated";

	public final static String CATEGORY_SAVED_RESPONSE_MESSAGE = "Category has been successfully updated";
	...
	public static final String BRAND_UPDATE_RESPONSE_MESSAGE = "Brand has been succesfully updated";

	public static final String BRAND_SAVED_RESPONSE_MESSAGE = "Brand succesfully created";
	...
	public static final String ORDER_CREATED_MESSAGE ="Order has been created succesfully";
